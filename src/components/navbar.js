...
<div class="flex justify-between mx-9 my-5 mb-10">
   <h1>Hello</h1>
   <svg onClick={handlebtnfalse} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<div class="flex flex-col gap-3 pl-8 pt-8">
  <Link href="/" className='font-medium'>
      ...
      <h1 className='font-medium relative right-3'>Blogs | Press Releases</h1>
...
<Image
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
   ...
   <div class="flex md:hidden" >
        ...
        <svg  onClick={handlebtntrue}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
